...
import { FadeIn } from '../App'; // We export FadeIn from App.jsx now
                    ...
                    <FadeIn>
                        <div className="text-center">
                            ...
                            <div className="mt-10 flex items-center justify-center gap-x-6">
                                <Link to="/contact" className="rounded-md bg-[#468289] px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-[#36454F] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Book a Consultation</Link>
                    ...
                    {portraitPackages.map((pkg) => (
                        <FadeIn key={pkg.name}>
                            <div className={`rounded-3xl p-8 ring-1 xl:p-10 ${pkg.highlight ? 'ring-2 ring-[#468289] bg-gray-50' : 'ring-gray-200'}`}>
                                ...
                                <Link to="/contact" className={`mt-6 block w-full rounded-md px-3 py-2 text-center text-sm font-semibold leading-6 shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 ${pkg.highlight ? 'bg-[#468289] text-white hover:bg-[#36454F]' : 'bg-white text-[#468289] ring-1 ring-inset ring-[#468289] hover:bg-gray-50'}`}>Book Now</Link>
